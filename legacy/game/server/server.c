...
ConsoleVariable_t cvServerPlayerModel = {"server_playermodel", MODEL_PLAYER, false, true,
                                         "Sets the main server-side player model."};
ConsoleVariable_t cvServerRespawnDelay = {"server_respawndelay", "40", false, true,
                                          "Sets the amount of time until a player respawns."};
ConsoleVariable_t cvServerSkill = {"server_skill", "1", false, true, "The level of difficulty."};
ConsoleVariable_t cvServerSelfDamage = {"server_selfdamage", "0", false, true,
                                        "If enabled, your weapons can damage you."};
ConsoleVariable_t cvServerMaxHealth = {"server_maxhealth", "200", false, true, "Sets the max amount of health."};
ConsoleVariable_t cvServerDefaultHealth = {"server_defaulthealth", "100", false, true,
                                           "Changes the default amount of health."};
...
ConsoleVariable_t cvServerGameClients = {"server_gameclients", "2", false, true,
                                         "Number of clients before round starts."};
ConsoleVariable_t cvServerWaypointDelay = {"server_waypointdelay", "5.0", false, true,
                                           "Delay before attempting to spawn another waypoint."};
ConsoleVariable_t cvServerWaypointSpawn = {"server_waypointspawn", "0", false, true,
                                           "if enabled, waypoints autospawn."};
ConsoleVariable_t cvServerWaypointParse = {"server_waypointparse", "", false, true,
                                           "Overrides the default path to load waypoints from."};
