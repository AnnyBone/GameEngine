...
void Particle_CreateEffect(ParticleType_t pType, ParticleBehaviour_t pBehaviour, PLVector3D vOrigin,
                           PLVector3D vDirection, float fVelocity, float fScale, int iCount, int iMaterial);
