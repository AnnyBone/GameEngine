...
#define ENTALPHA_ENCODE(a)	(((a)==0)?ENTALPHA_DEFAULT:PL_RINT(Math_Clamp(1,(a)*254.0f+1,255))) //server convert to byte to send to client
...
#define	DEFAULT_VIEWHEIGHT	28.0f
