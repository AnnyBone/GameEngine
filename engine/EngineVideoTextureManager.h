...
extern "C" {
	...
	// IMAGE LOADING
	gltexture_t *TexMgr_LoadImage(model_t *owner, const char *name, PLuint width, PLuint height,
                                  enum XTextureFormat format,
                                  uint8_t *data, const char *source_file, unsigned int source_offset,
                                  unsigned int flags);
